$(document).ready(function () {
  function positionnerBackground(rattachement, taille, emplacement) {
    ...
    elementsCibles.each(function () {
      ...
      function ajusterTailleSparkles() {
        ...
        var sparklesWidth = (parseFloat(taille) / 100) * largeurFenetre;
  ...
  // Appeler la fonction avec la valeur appropriée
  positionnerBackground("div#deroulement", "50", "left");
  positionnerBackground("section#principale", "50", "right");
});
